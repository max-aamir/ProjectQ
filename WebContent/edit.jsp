	...
	<section>
		...
		<hr>
			...
			if(flag==0){
				...
				out.print("<article class=\"upcoming-quiz-article\"><h4 class=\"upcoming-quiz-head\">"+qname+"</h4><h5 class=\"upcoming-quiz-date\">Register by: "+rd+"</h5><form method=\"post\" action=\"editor.jsp\"><input type=\"hidden\" name=\"qid\" value=\""+qid+"\"><input type=\"hidden\" name=\"quescount\" value=\""+quescount+"\"><input class=\"submit\"  type=\"submit\" value=\"Edit\"></form></article>");
				while(rs.next()){
					qname=rs.getString(1);
					rdate=rs.getString(2);
					qid=rs.getString(3);
